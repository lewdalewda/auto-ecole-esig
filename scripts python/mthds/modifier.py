...
def modifier():
    ...
    layout2 = [[sg.TabGroup([[sg.Tab('élèves', tab2_layout, key="elv")]], tooltip='TIP2')],    
              [sg.Button('quitter')]]    
    ...
    while True:    
        ...
        if event == "modifier voiture" :
            liste.append(3)
            window.extend_layout(window["elv"], [[sg.Input("entrer id",key='id3'),sg.Button("approuvercar")]])
        
  
        
        if event == "approuvercar" :
            if modifeleve == False:  
                id2 = values['id3']
                liste.append(id2)
        ...
        if event == "modifier heures" :
            liste.append(4)
            window.extend_layout(window["elv"], [[sg.Input("entrer id",key='id4'),sg.Button("approuverheure")]])
        
        if event == "approuverheure" :
            if modifeleve == False:  
                id2 = values['id4']
                liste.append(id2)
        ...
        if event == "date" :
            liste.append(1)
            window.extend_layout(window["elv"], [[sg.Input("entrer annee",key='annee')],[sg.Input("entrer mois",key='mois')],[sg.Input("entrer jour",key='jour'),sg.Button("approuver17")]])
        ...
        if event == "depart" :
            liste.append(7)
            window.extend_layout(window["elv"], [[sg.Input("entrer l'heure de départ ",key='heure')],[sg.Input("entrez les minutes ", key='minutes'),sg.Button("approuver23")]])
        ...
        if event == "fin" :
            liste.append(8)
            window.extend_layout(window["elv"], [[sg.Input("entrer l'heure de départ ",key='heure')],[sg.Input("entrez les minutes ", key='minutes'),sg.Button("approuver24")]])
